...
Cenario: Visualizacao de detalhes do evento com nomes com espaços
	Dado que o evento abaixo existe:
	|nome  |site  		       |descricao       |aprovado|estado|
	|guru sp|http://www.guru.com|encontro do guru|true    |SP	|
	Dado que acesso a pagina de detalhe do "guru-sp"
	Entao deveria ver "guru sp" na pagina	
